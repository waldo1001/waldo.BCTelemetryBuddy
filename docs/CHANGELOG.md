...
- 2025-10-15 17:05 — Created comprehensive UserGuide.md — 13 sections covering installation, setup, authentication, querying, saving queries, external references, Copilot integration, configuration, troubleshooting, and FAQ (chat-driven)
