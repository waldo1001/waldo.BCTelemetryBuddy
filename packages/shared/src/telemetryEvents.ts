...
export const TELEMETRY_EVENTS = {
  ...
  EXTENSION: {
    ...
    SETUP_POINTER_SHOWN: 'TB-EXT-019',
    GUIDED_SETUP_LAUNCHED: 'TB-EXT-020',
    WIZARD_WORKSPACE_RESOLVED: 'TB-EXT-021'
  },
  ...
  MCP: {
    ...
    WORKSPACE_RESOLVED: 'TB-MCP-003',
    ROOTS_DISCOVERY: 'TB-MCP-004',
    ERROR: 'TB-MCP-005',
    WORKSPACE_PROFILE_SWITCH: 'TB-MCP-006'
  },
